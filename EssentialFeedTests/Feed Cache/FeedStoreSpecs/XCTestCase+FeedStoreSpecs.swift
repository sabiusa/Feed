...
extension FeedStoreSpecs where Self: XCTestCase {
    ...
    func assertThatRetrieveDeliversFoundValuesOnNonEmptyCache(on sut: FeedStore, file: StaticString = #file, line: UInt = #line) {
        ...
        XCTAssertNil(error, "expected successful insertion", file: file, line: line)
    ...
    func assertThatDeleteDeliversNoErrorOnNonEmptyCache(on sut: FeedStore, file: StaticString = #file, line: UInt = #line) {
        let insetionError = insert((uniqueImageFeed().local, Date()), to: sut)
        XCTAssertNil(insetionError, "Expected insertion to succeed", file: file, line: line)
    ...
    func assertThatSideEffectsRunSerially(on sut: FeedStore, file: StaticString = #file, line: UInt = #line) {
        ...
        XCTAssertEqual(
            ...
            [op1, op2, op3],
            "Expected operations to run serially, but they finished in the wrong order",
            file: file,
            line: line
        )
    }
